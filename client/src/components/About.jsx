                    ...
                    <div className="flex flex-wrap -m-2">
                        <div className="xl:w-1/2 md:w-1/2 p-4 hover:drop-shadow-2xl">
                            <div className="border border-gray-200 p-8 rounded-lg">
                                ...
                                <p className="leading-relaxed text-base">
                                    At Digital Detox, our journey began with a passion for environmental conservation and a deep apprehension for the escalating problem of electronic waste. <br />
                        ...
                        <div className="xl:w-1/2 md:w-1/2 p-4 hover:drop-shadow-2xl">
                            <div className="border border-gray-200 p-8 rounded-lg">
                                ...
                                <p className="leading-relaxed text-base">
                                    Digital Detox dream of a future where every e-device is recycled responsibly, reducing the burden on our environment and conserving precious natural resources. <br />
